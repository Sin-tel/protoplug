...
function plugin.processBlock(samples, smax)
    for i = 0, smax do
        ...
        -- stylua: ignore start
        local s1 = shelf1.process(-0.38154601*d1 +0.628773*d2   -0.10215126*d3 -0.30873564*d4 +0.29937741*d5 +0.12424767*d6  -0.49660452*d7 +0.04042556*d8) * gain
        local s2 = shelf2.process(-0.2584172*d1  -0.55174203*d2 -0.06248554*d3 +0.37784024*d4 +0.57404789*d5 -0.03341235*d6  -0.38742040*d7 -0.03730490*d8) * gain
        local s3 =               ( 0.17616566*d1 -0.01007151*d2 -0.04866929*d3 -0.35528839*d4 +0.52151794*d5 +0.13894576*d6  +0.38018032*d7 -0.63595732*d8) * gain
        local s4 =               ( 0.12975732*d1 +0.03687724*d2 -0.76552876*d3 +0.09895528*d4 +0.17093164*d5 +0.34177725*d6  +0.26503808*d7 +0.41194924*d8) * gain
        local s5 =               ( 0.05112898*d1 -0.29865626*d2 -0.01737311*d3 -0.66020401*d4 +0.18506261*d5 -0.48593184*d6  +0.02308613*d7 +0.44845091*d8) * gain
        local s6 =               (-0.46884187*d1 +0.2952903*d2  +0.11892298*d3 +0.31459522*d4 +0.24989798*d5 -0.41323626*d6  +0.57250508*d7 +0.13748759*d8) * gain
        local s7 =               ( 0.32402592*d1 +0.20785793*d2 -0.46688196*d3 +0.19598948*d4 -0.05089573*d5 -0.66318809*d6  -0.23372278*d7 -0.31365027*d8) * gain
        local s8 =               (-0.64214657*d1 -0.28136637*d2 -0.40599807*d3 -0.22944654*d4 -0.42468347*d5 -0.02482170*d6  +0.07473791*d7 -0.32317593*d8) * gain
        -- stylua: ignore end
